<div class="main-buttons">
    <a href="<?= app()->route->getUrl('/') ?>" class="button main-buttons__button">Просмотр всех абонентов</a>
    <a href="<?= app()->route->getUrl('/') ?>" class="button main-buttons__button">Просмотр всех помещений</a>
    <a href="<?= app()->route->getUrl('/') ?>" class="button main-buttons__button">Просмотр всех подразделений</a>
